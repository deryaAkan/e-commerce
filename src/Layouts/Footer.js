  ...
  return (
    <>
      <div className="flex w-full flex-col items-center justify-center bg-[#FAFAFA]">
        <div className="flex w-4/5 justify-around flex-wrap items-center py-5">
          ...
          <div className="flex gap-2">
            ...
            <FontAwesomeIcon icon={faYoutube} style={{ color: "#23A6F0" }} />
        ...
        <div className="flex justify-start w-4/5 py-5">
          {footerInfo.map((info, index) => (
            <div
              key={index}
              className="w-full flex flex-col relative text-black text-left"
            >
          ...
          <form className="flex">
  <input className="text-sm max-w-fit" type="text" placeholder="Your E-mail" />
