      ...
      <div className="my-0 mx-auto max-w-[1050px] flex justify-between items-center gap-20">
        ...
        <div className="flex flex-col gap-7 w-[396px]">
          ...
          <div className="font-bold text-sm leading-[22px] flex gap-2.5">
            <NavLink to="/shop">
              <button className="bg-[#2DC071] text-white px-10 py-4 rounded-md border-2 border-[#2DC071] border-solid">
                BUY NOW
              </button>
            </NavLink>
            <NavLink to="/shop">
              <button className="bg-white text-[#2DC071] px-10 py-4 rounded-md border-2 border-[#2DC071] border-solid">
                READ MORE
              </button>
            </NavLink>
          </div>
