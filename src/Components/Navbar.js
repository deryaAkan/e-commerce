...
export default function Navbar() {
  return (
    <>
      <div className="flex w-3/4 justify-around flex-wrap">
        ...
        <div className="text-[#23A6F0] text-sm flex items-center gap-2 flex-grow justify-end sm:flex-wrap sm:justify-center">
          <img src={loginSvg} />
